...
app.get("/catering/dashboard",function(req,res){
    res.render('catering/catering-dashboard');
});

//route for the catering booking page
app.get("/catering/booking",function(req,res){
    res.render('catering/catering-booking');
});
